defmodule CocontrolWeb.AccountLive.Index do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok, stream(socket, :accounts, Accounts.list_accounts(user.id))}
  end
  ...
  @impl true
  def handle_info({CocontrolWeb.AccountLive.FormComponent, {:saved, account}}, socket) do
